<section class="content-header">
      <h1>
        Excel Translator
        <small>You can view all your Excel files here.</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Excel Files</h3>
              <input type="hidden" name="fileType" id="fileType" value="<?php echo $fileType;?>">
              <div class="box-tools">
                <a  href="<?php echo site_url('translate/excel/add')?>" class="btn pull-left">Add</a>
