<section class="content-header">
      <h1>
        Excel Translator
        <small>You can view edit Excel files here.</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="<?php echo site_url('translate/excel');?>"><i class="fa fa-dashboard"></i> Excel Translate</a></li>        
        <li class="active">Excel Edit</li>
      </ol>
    </section>
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" name="frmForm" id="frmForm" method="post" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                ...
                <button type="button" onclick="window.location='<?php echo site_url();?>translate/excel'" class="btn btn-default">Cancel</button>
